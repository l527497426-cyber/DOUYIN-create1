...
<header><nav class="top-nav">${['首页','AI 分身','世界书','随变','AI 工坊','造世界'].map((s,i)=>`<button class="${i===0?'selected':''}" data-card="${[null,0,2,1,3,4][i]}">${i===5?'<img class="icon" src="/assets/nav-create-world@2x.png" width="12" height="12" alt="">':img('part-2','imgNavIcon'+(i||''),'icon')}${s}</button>`).join('')}</nav><div class="account"><span class="account-points"><img src="/assets/account-points@2x.png" width="48" height="24" alt="积分 276"></span><img src="/assets/account-avatar@2x.png" class="mini-avatar" width="24" height="24" alt="用户头像"></div></header>
