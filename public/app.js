...
const pictures=[img('part-0','imgAi'),img('part-0','imgAi1')+img('part-0','imgAi2')+img('part-0','imgAi3')+'<span class="shade"></span>'+img('part-0','imgGroup2130969545','suibian-logo'),img('part-0','imgFrame2147242635'),'<span class="phone">'+img('part-0','imgRectangle1','phone-content')+img('part-0','imgRectangle2','phone-content')+img('part-0','imgSpaceBlack')+'</span>',img('part-0','imgFrame2147242864')];
